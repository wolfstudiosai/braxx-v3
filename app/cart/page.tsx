    ...
    return (
      <div className="min-h-screen pt-32 flex flex-col items-center justify-center text-center px-8 bg-black text-white">
        <div className="bg-white/5 p-16 rounded-[4rem] border border-white/10 shadow-2xl max-w-2xl space-y-8 animate-in zoom-in-95 duration-700">
          ...
          <button onClick={() => navigate('/')} className="inline-block px-12 py-5 bg-[#e2ff4a] text-black rounded-full font-black uppercase tracking-widest text-[10px] hover:bg-white transition-all">
            Return to Base
          </button>
        </div>
      </div>
    ...
    <div className="min-h-screen pt-20 flex flex-col lg:flex-row">
      <div className="w-full lg:w-1/2 h-[40vh] lg:h-auto relative overflow-hidden bg-black p-12 lg:p-20 flex flex-col justify-start">
        ...
        <div className="relative z-10 space-y-8 pt-12 text-white">
          <button onClick={() => navigate('/shop')} className="flex items-center gap-2 text-white/40 hover:text-[#e2ff4a] text-[10px] font-black uppercase tracking-widest transition-colors">
            ...
            <div className="space-y-6 animate-in slide-in-from-right-4 duration-500">
              ...
              {cart.length === 0 ? (
                <div className="py-24 text-center space-y-6">
                  ...
                  <button onClick={() => navigate('/shop')} className="inline-block px-8 py-4 bg-black text-white rounded-full text-[10px] font-black uppercase tracking-widest">Acquire Gear</button>
                </div>
              ) : (
