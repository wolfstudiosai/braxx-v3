        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center space-y-12 max-w-4xl mx-auto w-full">
          ...
          <form className="relative w-full max-w-md" onSubmit={(e) => e.preventDefault()}>
            <input 
              ...
              className="w-full bg-white/5 backdrop-blur-xl border-b-2 border-white/20 py-5 px-4 text-white text-sm font-black tracking-widest focus:outline-none focus:border-[#e2ff4a] transition-all placeholder:text-white/20 uppercase"
            />
            <button className="absolute right-2 top-1/2 -translate-y-1/2 p-3 text-white hover:text-[#e2ff4a] transition-all"><Send size={24} /></button>
          </form>
        </div>
